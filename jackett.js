...
Lampa.SettingsApi.addParam({
    ...
    onChange: function (value) {
     ...
     if (value == 'unknown') Lampa.Storage.set('jackett_url', 'http://188.119.113.252:9117')&Lampa.Storage.set('jackett_key', '1')&Lampa.Storage.set('jackett_interview', 'all')&Lampa.Storage.set('parse_in_search', true)&Lampa.Storage.set('parse_lang', 'lg');
     Lampa.Settings.update();
    },
     onRender: function (item) {
       setTimeout(function() {
